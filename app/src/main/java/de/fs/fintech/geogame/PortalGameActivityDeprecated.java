...
public class PortalGameActivityDeprecated extends Activity {
    private static Logger log = LoggerFactory.getLogger(PortalGameActivityDeprecated.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_portal_game_deprecated);

        FrameLayout frameLayout = (FrameLayout) findViewById(R.id.frame_layout_simulation);
    ...
    class SimulationView extends FrameLayout implements SensorEventListener {
        ...
        class Particle extends View {
            private float mPosX = (float) mHorizontalBound;
            private float mPosY = (float) mVerticalBound;
            private float mVelX;
            private float mVelY;
            ...
            public void computeNewPosition(float sx, float sy, float dT) {
            ...
            public void resolveCollisionWithBounds() {
                final float xmax = mHorizontalBound/2;
                final float ymax = mVerticalBound/2;
                final float x = mPosX;
                final float y = mPosY;
                if (x > xmax) {
                    mPosX = xmax;
        ...
        class BoxParticle extends View{
            private float mPosX = (float) Math.random();
            private float mPosY = (float) Math.random();


            public BoxParticle(Context context) {
                super(context);
            }

            public BoxParticle(Context context, AttributeSet attrs) {
                super(context, attrs);
            }

            public BoxParticle(Context context, AttributeSet attrs, int defStyleAttr) {
                super(context, attrs, defStyleAttr);
            }
            ...
            private void updatePositions(float sx, float sy, long timestamp) {
                ...
                if (mLastT != 0) {
                    ...
                    for (int i = 0; i < count; i++) {
                        ...
                        ball.computeNewPosition(sx, sy, dT);
                    }
                }
                mLastT = t;
            }
